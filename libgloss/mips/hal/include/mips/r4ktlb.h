...
/* R4000-style Index bits */
#define TLBIDX_MASK	0x3f
#define TLBIDX_SHIFT	0

/* R4000-style Random bits */
...
#ifdef __ASSEMBLER__
/*
 * R4000-style virtual memory regions (MIPS SDE only supports 32-bit addressing)
 */
...
/*
 * R4000-style can set the page size on each TLB entry, but remember
 * that the TLB entries come in pairs.
 */
#if _MIPS_ARCH_VR4100
...
/*
 * R4000-style TLB acccess functions
 */
...
/* R4000-style CP0 Context register */
...
/* R4000-style CP0 EntryHi register */
...
/* R4000-style CP0 EntryLo0 register */
...
/* R4000-style CP0 EntryLo1 register */
...
/* R4000-style CP0 PageMask register */
...
/* R4000-style CP0 Wired register */
