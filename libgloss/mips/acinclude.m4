...
case "${target}" in
  ...
  mips*-mti*-* | mips*-img*-*)
    ...
    MIPS_PART_SPECIFIC_OBJ=
    MIPS_PART_SPECIFIC_DEFINES=
    MIPS_SCRIPT_LIST="idt nullmon mti32 mti64_n32 mti64_64 uhi32 uhi64_64 uhi64_n
32 malta32-yamon bootcode"
    MIPS_BSP_LIST=""libidt.a libnullmon.a libuhi.a libyamon.a libhal.a libcm3_impl
.a"
    ;;
  mips*-lsi*-*)
